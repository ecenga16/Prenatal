...
class ProductCartController extends Controller
{
    public function addToCart(Request $request){
        ...
        $result = ProductCart::insert([
            ...
            'product_name' => $productDetails[0]['tittle'],
    ...
    public function CartOrder(Request $request){
        ...
        foreach($CartList as $CartListItem){
            ...
            $resultInsert = CartOrder::insert([
                'invoice_no' => "Prenatal".$invoice_no,
    ...
    public function PendingOrder(){
        ...
        return view('backend.orders.peending_orders',compact('orders'));
    ...
    public function DeleteOrder($id) {
     $orders = CartOrder::findOrFail($id)->delete();
          return back();
    }
