...
Route::get('/dashboard',[ProductListController::class, 'GetAllProducts'])->name('all.products');
...
Route::prefix('product')->group(function(){
    ...
    Route::get('/dashboard',[ProductListController::class, 'GetAllProducts'])->name('all.product');
    ...
    Route::get('/delete/{id}',[ProductListController::class, 'ProductDelete'])->name('product.delete');

    
    Route::get('/edit/{id}',[ProductListController::class, 'EditProduct'])->name('product.edit');
    Route::get('/update',[ProductListController::class, 'UpdateProduct'])->name('product.update');
