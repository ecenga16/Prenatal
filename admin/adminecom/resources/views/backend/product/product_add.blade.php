	    ...
	    <div class="row">
           ...
           <div class="border border-3 p-4 rounded">
			...
			<div class="mb-3">
				...
				<input type="text" name="tittle" class="form-control" id="inputProductTitle" placeholder="Enter product title">
			  </div>
...
<div class="form-check">
	 ...
	 <label class="form-check-label" for="flexCheckDefault2">COLLECTION</label>
	 </div>
